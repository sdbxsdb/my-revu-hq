...
COMMENT ON COLUMN users.subscription_tier IS 'User subscription tier: starter (15 SMS/month), pro (30 SMS/month), business (60 SMS/month), enterprise (custom/unlimited)';
